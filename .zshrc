...
export ZSH="/home/thewhistler/.oh-my-zsh"
...
alias vi=nvim
alias vim=nvim
alias minecraft='MESA_GL_VERSION_OVERRIDE=4.3 java -jar TLauncher/TLauncher-2.83.jar'
alias volume='ncpamixer'
alias vpn=''
#alias mycroft ='.~/gitClones/mycroft-core/start-mycroft.sh all'
